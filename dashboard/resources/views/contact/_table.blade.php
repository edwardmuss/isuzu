<table class="display table table-responsive table-bordered  table-striped">
    ...
    <tbody>
    @foreach($tech_assistance as $data)
        <tr>
            <td>{{$data->id}}</td>
            ...
            <div class="modal fade" id="{{$data->id}}" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <form method="post" action="{{route('technical-assistance.update', $data->id)}}">
                            @csrf
                            {{ method_field('PUT') }}
                            ...
                            <div class="modal-body">
                                <div class="well">
                                    <p>Commenting on <strong>{{$data->client_name}}'s</strong> technical assistance request</p>
                                </div>
