<table class="display table table-responsive table-bordered table-striped">
    ...
    <tr>
        ...
        <th>Client Names</th>
        <th style="min-width: 100px">Phone Numner</th>
            ...
            <div class="modal fade" id="{{$data->id}}" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <form method="post" action="{{route('locate-dealer.update', $data->id)}}">
                            @csrf
                            {{ method_field('PUT') }}
                            ...
                            <div class="modal-body">
                                <div class="well">
                                    <p>Commenting on <strong>{{$data->client_name}}'s</strong> locate a dealer request</p>
                                </div>
                                <label>Comment</label>
