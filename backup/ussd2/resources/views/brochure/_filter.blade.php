        ...
        <div class="panel-body">
            <form class="col-md-12" method="get">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" value="{{ isset($filters['brochure_type']) ? $filters['brochure_type'] : '' }}" class="form-control" name="brochure_type" placeholder="Brochure Type">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <label></label>
                    <a href="{{route('brochure.index')}}" class="form-control btn btn-default">Clear</a>
                </div>
            </form>
        </div>
    </section>
