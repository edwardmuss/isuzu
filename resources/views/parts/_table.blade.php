<table class="display table table-responsive table-bordered  table-striped">
    ...
    <tr>
        ...
        <th style="min-width: 150px">Vehicle Type</th>
        <th style="min-width: 100px">Parts Description</th>
        <th>Client Names</th>
            ...
            <div class="modal fade" id="{{$data->id}}" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <form method="post" action="{{route('parts.update', $data->id)}}">
                            @csrf
                            {{ method_field('PUT') }}
                            ...
                            <div class="modal-body">
                                <div class="well">
                                    <p>Commenting on <strong>{{$data->client_name}}
                                            's</strong> {{$data->vehicle_type}} {{$data->parts_desc}} part(s) request
                                    </p>
                                </div>
