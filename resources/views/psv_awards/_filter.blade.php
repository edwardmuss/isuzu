        ...
        <div class="panel-body">
            <form class="col-md-12" method="get">
                <div class="col-md-3">
                    ...
                    <input type="text" value="{{ isset($filters['sacco_name']) ? $filters['sacco_name'] : '' }}" class="form-control" name="sacco_name" placeholder="Sacco Name">
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <label></label>
                    <a href="{{route('psv-awards.index')}}" class="form-control btn btn-default">Clear</a>
                </div>
            </form>
        </div>
    </section>
