<table class="display table table-responsive  table-bordered table-striped">
    ...
    <tr>
        ...
        <th style="min-width: 100px">Brochure Type</th>
        <th style="min-width: 110px">Date Requested</th>
        <th>Comment</th>
        <th>Action</th>
    </tr>
    </thead>
            ...
            <div class="modal fade" id="{{$data->id}}" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                        <form method="post" action="{{route('brochure.update', $data->id)}}">
                            @csrf
                            {{ method_field('PUT') }}
                            ...
                            <div class="modal-body">
                                <div class="well">
                                    <p>Commenting on <strong>{{$data->client_name}}'s</strong> Brochure request</p>
                                </div>
                                <label>Comment</label>
